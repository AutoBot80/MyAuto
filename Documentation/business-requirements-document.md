...
| 3.132 | Apr 2026 | — | **FR-18b**: **`Playwright_insurance.txt`** trace workflow doc; **pre_process** — MISP tab resolver staged waits + same-tab fast path; VIN **MispDms** URL floor **2** s, **txtFrameNo** root-first attach **3** s/attempt; eKYC OVD ArrowDown settle default **48** ms — **LLD** **6.213**, **HLD** **1.134** |
| 3.132 | Apr 2026 | — | **FR-18b**: **pre_process** — MISP tab resolver staged **`wait_for_event`** + same-tab fast path; VIN **MispDms** URL floor **2** s, **txtFrameNo** root-first attach **3** s/attempt; eKYC OVD ArrowDown settle default **48** ms — **LLD** **6.213**, **HLD** **1.134** |
