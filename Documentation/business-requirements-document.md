...
| 3.41 | Mar 2026 | — | **§6.1a** / Fill DMS: logging-only cleanup (trial JSON / diag notes per **LLD** **6.91**). **§6.1a** target SOP unchanged; optional temporary stop after payments remains (**`SIEBEL_DMS_HARD_FAIL_BEFORE_BOOKING_AND_ORDER`**, **LLD** **6.92**). |
