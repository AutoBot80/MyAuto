...
| `skip_find` | Enquiry without Find | Skips finder | Basic + Save → mandatory re-find → care-of; then vehicle; **Generate Booking** after vehicle (**always**); allotment when **not** In Transit |
