...
| 5.3 | Mar 2026 | — | **`update_vehicle_master_from_dms`**: maps **full_chassis** / **full_engine**, **sku** → **dms_sku**, **raw_frame_num** / **raw_engine_num**, **dispatch_year** fallback for **year_of_mfg**, **ex_showroom_price**; runs after real Siebel when **`out['vehicle']`** is non-empty (including partial Add Enquiry scrape) |
