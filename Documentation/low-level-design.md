...
| 6.122 | Apr 2026 | — | **2W** MISP tile: **`aid="ctl00_TWO"`** / **`id="ctl00_TWO"`** first — **§2.4c**; **BRD** **3.68**; **Database DDL** **2.63**; **HLD** **1.58**. |
| 6.123 | Apr 2026 | — | Login page: **`button[type="submit"]`** (text **Sign In** / **Login** / **Log in**) before generic matchers — **§2.4c**; **BRD** **3.69**; **Database DDL** **2.64**; **HLD** **1.59**. |
| 6.124 | Apr 2026 | — | **`Playwright_DMS_*.txt`**: after master commit, JSON snapshot **`customer_master`** / **`vehicle_master`** / **`sales_master`** — **`fetch_three_masters_snapshot_for_log`**, **`append_playwright_dms_masters_committed_log`** — **§2.4d** intro; **BRD** **3.70**; **Database DDL** **2.65**; **HLD** **1.60**. |
