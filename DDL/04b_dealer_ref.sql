...
--   parent_id, phone, oem_id, auto_sms_reminders, rto_name, prefer_insurer, hero_cpi, insurance_pay, cpi_reqd
...
CREATE TABLE IF NOT EXISTS dealer_ref (
    ...
    insurance_pay VARCHAR(8) NOT NULL DEFAULT 'APD',
    ...
    CONSTRAINT chk_dealer_ref_insurance_pay CHECK (insurance_pay IN ('CC', 'APD')),
...
COMMENT ON COLUMN dealer_ref.insurance_pay IS 'MISP proposal Payment Mode: CC or APD — DDL/alter/35b_dealer_ref_insurance_pay_form_insurance_view.sql';
