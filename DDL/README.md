...
13. `23_challan_master_staging.sql` — requires `dealer_ref` (subdealer challan batch header)  
...
psql -h localhost -U postgres -d auto_ai -f DDL/23_challan_master_staging.sql
