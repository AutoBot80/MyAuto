-- Expose dealer_ref.insurance_addon on form_insurance_view.
-- Run after: DDL/alter/37b_dealer_ref_insurance_addon.sql, DDL/alter/35b_dealer_ref_insurance_pay_form_insurance_view.sql
...
COMMENT ON VIEW form_insurance_view IS
    'Single-row projection per sale: customer_master, vehicle_master, latest insurance_master row, dealer_ref (incl. prefer_insurer, hero_cpi, insurance_pay, insurance_addon)';
