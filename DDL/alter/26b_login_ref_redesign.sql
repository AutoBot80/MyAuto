-- Replace login_ref: login_id is user text PK; email nullable, not unique.
-- Drops existing table — data lost.

DROP TABLE IF EXISTS login_ref CASCADE;

CREATE TABLE login_ref (
