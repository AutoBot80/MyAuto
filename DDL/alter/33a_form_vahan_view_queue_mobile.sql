-- form_vahan_view: prefer rto_queue.customer_mobile when operator chose alternate Vahan OTP mobile.
-- Run after: 10e_form_vahan_view.sql (or any prior form_vahan_view definition).
