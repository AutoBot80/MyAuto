...
; Canonical: resources/build/installer.nsh (electron-builder uses that path via buildResources).
...
!macro customInstall
  ...
  IfFileExists "$R5\.env" sdr_env_exists
    ...
    FileWrite $9 "DMS_BASE_URL=https://connect.heromotocorp.biz/edealerHMCL_enu$\r$\n"
